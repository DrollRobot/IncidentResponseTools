New-Alias -Name 'InboxRules' -Value 'Get-UserInboxRules' -Force
function Get-UserInboxRules {
    ...
    process {
        ...
        foreach ( $ScriptUserObject in $ScriptUserObjects ) {
            ...
            # export raw data
            Write-Host "Exporting raw data to: ${XmlOutputPath}"
            ...
            # save and close
            Write-Host "Exporting to: ${ExcelOutputPath}"
            if ( $Open ) {
